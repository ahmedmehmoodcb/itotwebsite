      ...
      <div className="mx-3 bg-danger">
        <div className="row g-0 px-4">
          <div className="col-6 text-center " style={{ minHeight: "50px" }}>
            <h6 className="py-2 text-start text-white">Become A 21 century</h6>
          </div>
          <div
            className="col-6 d-flex justify-content-end align-items-center text-white p-2"
            style={{ minHeight: "50px" }}
          >
            <Link to="mailto:info@itot.pk" className="btn    text-white mx-2">
              info@itot.pk
            </Link>
